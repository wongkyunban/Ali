...
import com.wong.ali.utils.RegularVerificationUtils;
...
public class ScanQrActivity extends AppCompatActivity implements QRCodeView.Delegate, EasyPermissions.PermissionCallbacks {
    ...
    private ResultHandler rsHandler = new ResultHandler();
    ...
    class ResultHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (result.startsWith("http")) {
                BrowserActivity.startActivity(ScanQrActivity.this, result);

            } else if (RegularVerificationUtils.startWithIP(result) || RegularVerificationUtils.startWithDomainName(result)) {
                //TODO wait to test
                BrowserActivity.startActivity(ScanQrActivity.this, "http://" + result);

            } else if (result.contains("WIFI")) {
                WIFIActivity.startActivity(ScanQrActivity.this, result);
            } else {
                QrEmptyActivity.startActivity(ScanQrActivity.this, result);
            }
            finish();
    ...
    private void handlerQrResult(String rs) {
        Message msg = rsHandler.obtainMessage();
        msg.obj = rs;
        rsHandler.handleMessage(msg);
    }
